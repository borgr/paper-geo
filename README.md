...
| [docs/RUNBOOK.md](docs/RUNBOOK.md) | the operating design — the four clocks, who owns each step, and where it is weak |
| [docs/SIDECAR_DESIGN.md](docs/SIDECAR_DESIGN.md) | how to write the per-paper sidecar, and the format decisions still open |
