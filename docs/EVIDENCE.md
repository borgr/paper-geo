...
close to unanswerable at 111 papers, and this section says so rather than dressing
...
unit is a question: ~111 papers × 6 questions ≈ 666 questions, ~333 per arm, with the
...
Put a number on it: ~111 papers × ~4 months × half coverage ≈ 222 paper-months of
...
| Cost | Size |
|---|---|
| Measurement labour | The dominant one. 2 rounds × ~666 questions × 4 engines, and two engines have no API for this — manual runs or a browser harness. Tens of hours, or a build |
...
The payoff if it does not work: you stop writing sidecars for 111 papers (~19 hours)
