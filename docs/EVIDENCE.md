...
close to unanswerable at 112 papers, and this section says so rather than dressing
...
unit is a question: ~112 papers × 6 questions ≈ 672 questions, ~336 per arm, with the
...
Put a number on it: ~112 papers × ~4 months × half coverage ≈ 224 paper-months of
...
| Cost | Size |
|---|---|
| Measurement labour | The dominant one. 2 rounds × ~672 questions × 4 engines, and two engines have no API for this — manual runs or a browser harness. Tens of hours, or a build |
...
The payoff if it does not work: you stop writing sidecars for 112 papers (~19 hours)
