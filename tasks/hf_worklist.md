...
Live as of the last `python scripts/audit_identity.py` (or `hf_papers.py --live`): **102 claimed**, **2 pending**, **0 to claim**, **0 to index**, **0 blocked upstream**.
...
## Pending — 2 claims in moderation
