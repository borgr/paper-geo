...
- ask:
    practitioner: Which architecture should I use for small-scale language model pretraining?
    unsorted:
...
- ask:
    practitioner: What should I read about human-scale or data-efficient language modeling
