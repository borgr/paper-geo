...
Then promote it:  python scripts/draft_sidecars.py --accept fuse-to-forget-bias-reduction-and-selective-memorization-thr

Stamp: spec=8f05813a4658 checks=pass body=59a0e95f8179
-->
---
key: zaman2024fuse
