...
THIS PAPER ALREADY HAS A LIVE SIDECAR, and this draft would replace it. Start here:
  ...
  diff data/sidecars/compeft-compression-for-communicating-parameter-efficient-up.md data/sidecars/drafts/compeft-compression-for-communicating-parameter-efficient-up.md
...
Then, if the replacement is the one you want:
  ...
  python scripts/draft_sidecars.py --accept compeft-compression-for-communicating-parameter-efficient-up --replace

Stamp: spec=2bd8f8ceab46 checks=pass body=155b1664ad3a
-->
---
