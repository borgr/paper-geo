...
Then promote it:  python scripts/draft_sidecars.py --accept enhancing-the-transformer-decoder-with-transition-based-synt

Stamp: spec=8f05813a4658 checks=pass body=ee9cdbcab848
-->
---
