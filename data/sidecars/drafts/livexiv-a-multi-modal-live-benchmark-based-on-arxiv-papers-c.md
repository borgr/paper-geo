...
Then promote it:  python scripts/draft_sidecars.py --accept livexiv-a-multi-modal-live-benchmark-based-on-arxiv-papers-c

Stamp: spec=8f05813a4658 checks=pass body=ae96016f11bd
-->
---
claims:
