...
Then promote it:  python scripts/draft_sidecars.py --accept some-grammatical-errors-are-frequent-others-are-important

Stamp: spec=8f05813a4658 checks=pass body=e450366de7d6
-->
---
key: choshen2022some
