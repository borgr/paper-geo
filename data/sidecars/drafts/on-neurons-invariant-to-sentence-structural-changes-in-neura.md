...
THIS PAPER ALREADY HAS A LIVE SIDECAR, and this draft would replace it. Start here:
  ...
  diff data/sidecars/on-neurons-invariant-to-sentence-structural-changes-in-neura.md data/sidecars/drafts/on-neurons-invariant-to-sentence-structural-changes-in-neura.md
...
Then, if the replacement is the one you want:
  ...
  python scripts/draft_sidecars.py --accept on-neurons-invariant-to-sentence-structural-changes-in-neura --replace

Stamp: spec=2bd8f8ceab46 checks=pass body=5012488c66bd
-->
---
claims:
- id: confound-shallow
