...
Then promote it:  python scripts/draft_sidecars.py --accept on-neurons-invariant-to-sentence-structural-changes-in-neura

Stamp: spec=8f05813a4658 checks=1 body=7dd1d15c7f67
-->
---
claims:
- id: confound-shallow
