...
Then promote it:  python scripts/draft_sidecars.py --accept mediators-in-determining-what-processing-bert-performs-first

Stamp: spec=8f05813a4658 checks=3 body=8a03abb2f8f4
-->
---
