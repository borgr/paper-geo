...
THIS PAPER ALREADY HAS A LIVE SIDECAR, and this draft would replace it. Start here:
  ...
  diff data/sidecars/label-sleuth-from-unlabeled-text-to-a-classifier-in-a-few-ho.md data/sidecars/drafts/label-sleuth-from-unlabeled-text-to-a-classifier-in-a-few-ho.md
...
Then, if the replacement is the one you want:
  ...
  python scripts/draft_sidecars.py --accept label-sleuth-from-unlabeled-text-to-a-classifier-in-a-few-ho --replace

Stamp: spec=2bd8f8ceab46 checks=pass body=7b575d62f0e4
-->
---
claims:
- id: what-it-is
