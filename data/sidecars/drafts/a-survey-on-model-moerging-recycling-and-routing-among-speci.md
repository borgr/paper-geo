...
THIS PAPER ALREADY HAS A LIVE SIDECAR, and this draft would replace it. Start here:
  ...
  diff data/sidecars/a-survey-on-model-moerging-recycling-and-routing-among-speci.md data/sidecars/drafts/a-survey-on-model-moerging-recycling-and-routing-among-speci.md
...
Then, if the replacement is the one you want:
  ...
  python scripts/draft_sidecars.py --accept a-survey-on-model-moerging-recycling-and-routing-among-speci --replace

Stamp: spec=2bd8f8ceab46 checks=pass body=e5c56aa9eb34
-->
---
claims:
