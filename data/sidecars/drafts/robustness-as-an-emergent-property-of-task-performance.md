...
Then promote it:  python scripts/draft_sidecars.py --accept robustness-as-an-emergent-property-of-task-performance

Stamp: spec=8f05813a4658 checks=2 body=7bd67cf6f2b6
-->
---
