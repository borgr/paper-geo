...
Then promote it:  python scripts/draft_sidecars.py --accept cross-lingual-exploration-for-parametric-knowledge

Stamp: spec=8f05813a4658 checks=pass body=6cf42f8eadab
-->
---
claims:
- id: kt-gain
