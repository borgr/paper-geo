...
THIS PAPER ALREADY HAS A LIVE SIDECAR, and this draft would replace it. Start here:
  ...
  diff data/sidecars/the-future-of-open-human-feedback.md data/sidecars/drafts/the-future-of-open-human-feedback.md
...
Then, if the replacement is the one you want:
  ...
  python scripts/draft_sidecars.py --accept the-future-of-open-human-feedback --replace

Stamp: spec=2bd8f8ceab46 checks=pass body=d9d2d5cabece
-->
---
