...
Then promote it:  python scripts/draft_sidecars.py --accept instructions-shape-production-of-language-not-processing

Stamp: spec=8f05813a4658 checks=pass body=1ba937a373f3
-->
---
claims:
