...
Then promote it:  python scripts/draft_sidecars.py --accept the-mighty-torr-a-benchmark-for-table-reasoning-and-robustne

Stamp: spec=8f05813a4658 checks=pass body=c43f456e50ce
-->
---
claims:
- id: best-score-050
