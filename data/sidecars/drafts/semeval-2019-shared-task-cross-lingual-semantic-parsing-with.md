...
Then promote it:  python scripts/draft_sidecars.py --accept semeval-2019-shared-task-cross-lingual-semantic-parsing-with

Stamp: spec=8f05813a4658 checks=pass body=d1d64bad16d6
-->
---
