...
THIS PAPER ALREADY HAS A LIVE SIDECAR, and this draft would replace it. Start here:
  ...
  diff data/sidecars/part-of-speech-and-universal-dependency-effects-on-english-a.md data/sidecars/drafts/part-of-speech-and-universal-dependency-effects-on-english-a.md
...
Then, if the replacement is the one you want:
  ...
  python scripts/draft_sidecars.py --accept part-of-speech-and-universal-dependency-effects-on-english-a --replace

Stamp: spec=2bd8f8ceab46 checks=pass body=16fc41b8a044
-->
---
