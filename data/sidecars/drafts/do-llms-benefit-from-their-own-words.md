...
THIS PAPER ALREADY HAS A LIVE SIDECAR, and this draft would replace it. Start here:
  ...
  diff data/sidecars/do-llms-benefit-from-their-own-words.md data/sidecars/drafts/do-llms-benefit-from-their-own-words.md
...
Then, if the replacement is the one you want:
  ...
  python scripts/draft_sidecars.py --accept do-llms-benefit-from-their-own-words --replace

Stamp: spec=fd01ca70bea8 checks=pass body=71abf28cd32c
-->
---
