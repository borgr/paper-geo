...
Then promote it:  python scripts/draft_sidecars.py --accept a-latent-variable-framework-for-scaling-laws-in-large-langua

Stamp: spec=8f05813a4658 checks=pass body=2e91de95832d
-->
---
key: cai2025latent
